			...
			<div class="[&>div>div:nth-of-type(1)]:rounded-t-none [&_table]:bg-white dark:[&_table]:bg-gray-800">
				<flux:table :paginate="$resources">
					<flux:table.columns>
						...
						<flux:table.column>Priority Score</flux:table.column>
					...
					<flux:table.rows>
						@forelse($resources as $resource)
							<flux:table.row wire:key="row-{{ $resource->id }}">
								...
								<flux:table.cell>
									<div class="flex items-center gap-3">
										...
										<div class="flex flex-col w-80 whitespace-normal">
											<div class="break-all">
												<a href="{{ $resource->resourceable->url }}" target="_blank">{{ $resource->resourceable->url }}</a>
											</div>
								...
								<flux:table.cell>
									@if($resource->resourceable->priority_score)
										<flux:badge>{{ $resource->resourceable->priority_score }}</flux:badge>
									@else
										&mdash;
									@endif
								</flux:table.cell>
